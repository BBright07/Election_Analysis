...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (c_votes > top_county_turnout) and (c_vote_percentage > top_county_percentage):
                top_county_turnout = c_votes
                top_county_percentage = c_vote_percentage
    ...
    top_county_summary = (
            ...
            f"Top county voter turnout: {top_county_turnout:,}\n"
            f"Top percentage: {top_county_percentage:.1f}%\n"
            f"----------------------\n")
